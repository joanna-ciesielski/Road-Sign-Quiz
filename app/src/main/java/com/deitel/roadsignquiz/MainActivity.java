...
public class MainActivity extends AppCompatActivity {
   ...
   public static final String CATEGORIES = "pref_regionsToInclude";
   ...
   private OnSharedPreferenceChangeListener preferencesChangeListener =
      new OnSharedPreferenceChangeListener() {
         ...
         public void onSharedPreferenceChanged(
            ...
            if (key.equals(CHOICES)) { // # of choices to display changed
            ...
            else if (key.equals(CATEGORIES)) { // regions to include changed
               Set<String> regions =
               ...
               if (regions != null && regions.size() > 0) {
                  ...
                  // must select one category--set Signs as default
                  SharedPreferences.Editor editor =
                     sharedPreferences.edit();
                  regions.add(getString(R.string.default_region));
                  editor.putStringSet(CATEGORIES, regions);
                  editor.apply();
